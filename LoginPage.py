...
class LoginPage:
    def __init__(self, window):
        ...
        self.login = Button(self.lgn_button_label, text='LOGIN', font=("yu gothic ui", 13, "bold"), width=25, bd=0,
                            bg='#3047ff', cursor='hand2', activebackground='#3047ff', fg='white', command=self.login_user)
    ...
    def login_user(self):
        ...
        #     query = 'select * from register where name=%s or password=%s'
